...
mod tests {
    ...
    fn make_node(template: TaskTemplate, node_id: &str) -> WorkflowNodeInstanceEntity {
        ...
        WorkflowNodeInstanceEntity {
            ...
            task_instance: crate::task::entity::task_definition::TaskInstanceEntity {
                ...
                tenant_id: "t1".into(), task_id: "".into(),
                task_name: "pause".into(), task_type: TaskType::Pause,
    ...
    fn make_instance() -> WorkflowInstanceEntity {
        ...
        WorkflowInstanceEntity {
            ...
            entry_node: "p1".into(), current_node: "p1".into(),
            nodes: vec![], epoch: 0,
    ...
    async fn execute_auto_mode_sets_suspended_with_resume_at() {
        ...
        let template = TaskTemplate::Pause(PauseTemplate { wait_seconds: 60, mode: PauseMode::Auto });
    ...
    async fn execute_manual_mode_sets_suspended() {
        let plugin = PausePlugin::new();
        let template = TaskTemplate::Pause(PauseTemplate { wait_seconds: 120, mode: PauseMode::Manual });
    ...
    async fn invalid_template_returns_error() {
        let plugin = PausePlugin::new();
        let mut node = make_node(TaskTemplate::Http(crate::task::entity::task_definition::TaskHttpTemplate {
